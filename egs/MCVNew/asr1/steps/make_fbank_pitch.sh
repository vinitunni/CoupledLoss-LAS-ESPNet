...
if [ -f $data/segments ]; then
  ...
  pitch_feats="ark,s,cs:extract-segments scp,p:$scp $logdir/segments.JOB ark:- | compute-kaldi-pitch-feats --verbose=2 --config=$pitch_config --sample-frequency=16000 ark:- ark:- | process-kaldi-pitch-feats $postprocess_config_opt ark:- ark:- |"
  ...
  pitch_feats="ark,s,cs:compute-kaldi-pitch-feats --verbose=2 --config=$pitch_config --sample-frequency=16000 scp,p:$logdir/wav.JOB.scp ark:- | process-kaldi-pitch-feats $postprocess_config_opt ark:- ark:- |"
